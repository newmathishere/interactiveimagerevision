$(document).ready(function () {
	...
	$('#circle_snow').click(function () {
		showInfo3();
		$('#popIn3').text('A majority of New York City residents (53 percent) who were actively enrolled in a Methadone program were Hispanic/Latino. A plurality of active Methadone patients in 2016 were from the Bronx (36 percent)').addClass('popIn-info');
	});
